...
import {
  ...
  const Footer = () => {
    ...
    return (
      <div className='bg-secondary mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-primary'>
        {/* Left section with brand and social icons */}
        <div>
          <h1 className='w-full text-3xl lg:text-4xl xl:text-5xl font-bold text-[#00df9a]'>E-Dalil</h1>
          <p className='py-4'>
